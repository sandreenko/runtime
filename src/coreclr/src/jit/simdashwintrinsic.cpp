...
#error Unsupported platform
    ...
    switch (numArgs)
    {
        case 0:
        {
            ...
            return gtNewSimdAsHWIntrinsicNode(retType, hwIntrinsic, baseType, simdSize, clsHnd);
        }
        ...
        case 1:
        {
            ...
            assert(!SimdAsHWIntrinsicInfo::NeedsOperandsSwapped(intrinsic));
            return gtNewSimdAsHWIntrinsicNode(retType, op1, hwIntrinsic, baseType, simdSize, clsHnd);
        }
        ...
        case 2:
        {
            ...
            return gtNewSimdAsHWIntrinsicNode(retType, op1, op2, hwIntrinsic, baseType, simdSize, clsHnd);
        }
    }
            ...
            switch (intrinsic)
            {
                ...
                case NI_VectorT256_Abs:
                {
                    if (varTypeIsFloating(baseType))
                    {
                        ...
                        bitMask = gtNewSIMDNode(retType, bitMask, SIMDIntrinsicInit, baseType, simdSize, clsHnd);
                        ...
                        return gtNewSimdAsHWIntrinsicNode(retType, op1, bitMask, intrinsic, baseType, simdSize, clsHnd);
                    }
                    ...
                    {
                        return gtNewSimdAsHWIntrinsicNode(retType, op1, NI_SSSE3_Abs, baseType, simdSize, clsHnd);
                    }
                    else
                    {
                        GenTree*       tmp;
                        ...
                        // op1 = op1 < Zero
                        tmp         = gtNewSIMDVectorZero(retType, baseType, simdSize, clsHnd);
                        ...
                        tmp =
                            gtNewSimdAsHWIntrinsicNode(retType, tmp, op1Dup1, hwIntrinsic, baseType, simdSize, clsHnd);
        ...
        case 2:
        {
            ...
            switch (intrinsic)
            {
                ...
                case NI_Vector3_op_Division:
                {
                    ...
                    GenTree* retNode =
                        gtNewSimdAsHWIntrinsicNode(retType, op1, op2, NI_SSE_Divide, baseType, simdSize, clsHnd);
                    ...
                    retNode = gtNewSimdAsHWIntrinsicNode(retType, retNode, gtNewIconNode(shiftCount, TYP_INT),
                                                         NI_SSE2_ShiftLeftLogical128BitLane, TYP_INT, simdSize, clsHnd);
                    ...
                    retNode =
                        gtNewSimdAsHWIntrinsicNode(retType, retNode, gtNewIconNode(shiftCount, TYP_INT),
                                                   NI_SSE2_ShiftRightLogical128BitLane, TYP_INT, simdSize, clsHnd);
                ...
                case NI_VectorT256_Min:
                {
                    if ((baseType == TYP_BYTE) || (baseType == TYP_USHORT))
                    {
                        ...
                        GenTree* constVector =
                            gtNewSIMDNode(retType, constVal, nullptr, SIMDIntrinsicInit, TYP_INT, simdSize, clsHnd);
                        ...
                        op1 = gtNewSimdAsHWIntrinsicNode(retType, op1, op2, hwIntrinsic, baseType, simdSize, clsHnd);
                    ...
                    else
                    {
                        ...
                        op1 =
                            gtNewSimdAsHWIntrinsicNode(retType, op1, gtNewIconNode(4, TYP_INT),
                                                       NI_SSE2_ShiftRightLogical128BitLane, baseType, simdSize, clsHnd);
                        ...
                        op2 = gtNewSimdAsHWIntrinsicNode(retType, op2, gtNewIconNode(SHUFFLE_XXZX, TYP_INT),
                                                         NI_SSE2_Shuffle, baseType, simdSize, clsHnd);

                        // op1 = Sse2.Multiply(op1Dup.AsUInt64(), op2Dup.AsUInt64()).AsInt32()
                        op1 = gtNewSimdAsHWIntrinsicNode(retType, op1Dup, op2Dup, NI_SSE2_Multiply, TYP_ULONG, simdSize,
                                                         clsHnd);
                                              ...
                                              GenTree*             op3)
{
    ...
    if (compOpportunisticallyDependsOn(InstructionSet_SSE41))
    {
        ...
        return gtNewSimdAsHWIntrinsicNode(retType, op3, op2, op1, hwIntrinsic, baseType, simdSize, clsHnd);
    }
#endif // TARGET_XARCH
    ...
    op2         = gtNewSimdAsHWIntrinsicNode(retType, op2, op1, hwIntrinsic, baseType, simdSize, clsHnd);
    ...
    op3 = gtNewSimdAsHWIntrinsicNode(retType, op3, op1Dup, hwIntrinsic, baseType, simdSize, clsHnd);

    // result = op2 | op3
    hwIntrinsic = SimdAsHWIntrinsicInfo::lookupHWIntrinsic(NI_VectorT128_op_BitwiseOr, baseType);
    return gtNewSimdAsHWIntrinsicNode(retType, op2, op3, hwIntrinsic, baseType, simdSize, clsHnd);
}
    ...
    switch (intrinsic)
    {
        ...
        case NI_VectorT256_Equals:
        {
            ...
            else
            {
                ...
                GenTree* tmp = gtNewSimdAsHWIntrinsicNode(retType, op1, op2, hwIntrinsic, TYP_INT, simdSize, clsHnd);
        ...
        case NI_VectorT256_LessThan:
        {
            ...
            if (varTypeIsUnsigned(baseType))
            {
                ...
                GenTree* constVector =
                    gtNewSIMDNode(retType, constVal, nullptr, SIMDIntrinsicInit, constVal->TypeGet(), simdSize, clsHnd);
                ...
                // op1 = op1 - constVector
                op1 = gtNewSimdAsHWIntrinsicNode(retType, op1, constVector, hwIntrinsic, opType, simdSize, clsHnd);

                // op2 = op2 - constVector
                op2 = gtNewSimdAsHWIntrinsicNode(retType, op2, constVectorDup, hwIntrinsic, opType, simdSize, clsHnd);
            }
            ...
            else
            {
                ...
                hwIntrinsic = SimdAsHWIntrinsicInfo::lookupHWIntrinsic(NI_VectorT128_op_BitwiseAnd, baseType);
                op2         = gtNewSimdAsHWIntrinsicNode(retType, v, u, hwIntrinsic, baseType, simdSize, clsHnd);
