...
inline GenTree* Compiler::gtNewOperNode(genTreeOps oper, var_types type, GenTree* op1, bool doSimplifications)
{
    ...
    // TODO seandree: Can't get address of some nodes, like call or simd, but the master branch does it
    // and allows the later phases to eliminate these addr nodes. Fix such cases and uncoment that assert.
